...
"""
###　↓2車両VRPを初期ルートを与えずに解く場合のコード↓　###
def perform_gat_exchange(original_routes, customers, PD_pairs, vehicle_num_list, depot_id_list, vehicle_capacity):
...
###　↓2車両VRPを暫定ルートを初期ルートとして与えたうえで解く場合↓ ###
